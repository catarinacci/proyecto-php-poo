...
<a href="<?= base_url?>producto/crear" class="button " id="crear">
    Crear producto
</a>
...
<table >
    ...
    <?php while ($pro = $productos->fetch_object()):?>
        <tr>
            ...
            <td><?= $pro->stock;?></td>
            <td>
                <a href="<?=base_url?>producto/editar&id=<?=$pro->id?>" class="button button-getion">Editar</a>
                <a href="<?=base_url?>producto/eliminar&id=<?=$pro->id?>" class="button button-getion button-red">Eliminar</a>
            </td>
        </tr>
    <?php endwhile;?>
</table>